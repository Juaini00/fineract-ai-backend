...
-- 10 penarikan terbesar per bulan kalender selama 12 bulan terakhir. Ditulis
-- independen dari queries/savings/withdrawal_monthly_top_n.sql (lihat catatan
-- pada savings_deposit_monthly_top_n.sql).
