...
| Dokumen | Menjawab |
| --- | --- |
| [**build-order.md**](build-order.md) | Tangga L0–L8 plus gerbang cakupan katalog L1C, gerbang kelulusan tiap lapisan, dan aturan mengikat untuk agen. **Lapisan mana yang boleh dikerjakan berikutnya** |
